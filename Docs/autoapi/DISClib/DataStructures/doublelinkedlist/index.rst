:py:mod:`DISClib.DataStructures.doublelinkedlist`
=================================================
...
.. py:class:: DoubleLinked
   ...
   :param Generic: TAD (Tipo Abstracto de Datos) o ADT (Abstract Data Type que representa un DoubleLinked o Lista Doblemente Encadenada.
   :type Generic: T
