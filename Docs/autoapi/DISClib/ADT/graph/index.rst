:py:mod:`DISClib.ADT.graph`
===========================

.. py:module:: DISClib.ADT.graph
...
.. autoapisummary::
   ...
   DISClib.ADT.graph.newGraph
   DISClib.ADT.graph.insertVertex
   DISClib.ADT.graph.removeVertex
   DISClib.ADT.graph.numVertices
   DISClib.ADT.graph.numEdges
   DISClib.ADT.graph.vertices
   DISClib.ADT.graph.edges
   DISClib.ADT.graph.degree
   DISClib.ADT.graph.outdegree
   DISClib.ADT.graph.indegree
   DISClib.ADT.graph.getEdge
   DISClib.ADT.graph.addEdge
   DISClib.ADT.graph.containsVertex
   DISClib.ADT.graph.adjacents
   DISClib.ADT.graph.adjacentEdges
   DISClib.ADT.graph.graphSelector
...
.. autoapisummary::
   ...
   DISClib.ADT.graph.switch_module
