:py:mod:`Src.DISClib.ADT.dynamic`
=================================

.. py:module:: Src.DISClib.ADT.dynamic
...
.. autoapisummary::
   ...
   Src.DISClib.ADT.dynamic.STRUCT_PGK_PATH
   Src.DISClib.ADT.dynamic.ADT_PGK_PATH


.. py:data:: STRUCT_PGK_PATH
   :type: str
   :value: 'Src.DISClib.DataStructures'

   Ruta relativa del paquete principal para las estructuras de datos.

.. py:data:: ADT_PGK_PATH
   :type: str
   :value: 'DISClib.ADT'
