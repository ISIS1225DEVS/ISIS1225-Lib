:py:mod:`Src.DISClib.Utils.numbers`
===================================

.. py:module:: Src.DISClib.Utils.numbers
...
.. autoapisummary::
   ...
   Src.DISClib.Utils.numbers.is_prime
   Src.DISClib.Utils.numbers.next_prime
   Src.DISClib.Utils.numbers.previous_prime
   Src.DISClib.Utils.numbers.hash_compress
...
.. py:function:: hash_compress(key: Src.DISClib.Utils.default.T, scale: int, shift: int, prime: int, mcapacity: int) -> int
   ...
   *hash_compress()* función de compresión para los índices de las tablas de Hash utilizando el método MAD (Multiply-Add-and-Divide).
   ...
   :param key: llave para calcular el índice en la tabla de Hash, Puede ser cualquier tipo de dato nativo en Python o definido por el usuario.
   :type key: T
