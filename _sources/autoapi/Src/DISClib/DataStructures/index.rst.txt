:py:mod:`Src.DISClib.DataStructures`
====================================

.. py:module:: Src.DISClib.DataStructures
...
.. autoapisummary::
   ...
   Src.DISClib.DataStructures.ArrayList
   Src.DISClib.DataStructures.SingleLinked
   Src.DISClib.DataStructures.DoubleLinked
   Src.DISClib.DataStructures.SeparateChaining
   Src.DISClib.DataStructures.LinearProbing
...
.. autoapisummary::
   ...
   Src.DISClib.DataStructures.HashTable
...
.. py:class:: ArrayList
   ...
   **ArrayList** representa la estructura de datos para arreglos dinamicos (*ArrayList*), Implementada con Generic[T] y @dataclass para que sea una estructura de datos genérica.
   ...
   .. py:method:: get_first() -> Src.DISClib.Utils.default.T
   ...
   .. py:method:: get_last() -> Src.DISClib.Utils.default.T
   ...
   .. py:method:: get_element(pos: int) -> Src.DISClib.Utils.default.T
   ...
   .. py:method:: remove_first() -> Src.DISClib.Utils.default.T
   ...
   .. py:method:: remove_last() -> Src.DISClib.Utils.default.T
   ...
   .. py:method:: remove_element(pos: int) -> Src.DISClib.Utils.default.T
