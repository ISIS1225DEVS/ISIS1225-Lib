...
class AdjacencyList(Generic[T]):
    ...
    """
    Función de comparación opcional que se utiliza para comparar los elementos del AdjacencyList, por defecto es None y el *__post_init__()* configura la función por defecto *lt_default_cmp_funcion()*.
    """
